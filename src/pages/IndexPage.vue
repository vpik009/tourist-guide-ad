    ...
    <div v-if="page==1">
          ...
          <q-card-section>
            ...
            <div class="q-ma-md q-mt-xl" >
              ...
              <div class="text-center col-12 q-ma-md">
                <text class="row justify-center text-h6">Мы современная туристическая компания которую ведёт Малайзийский Дух. Индивидуальный подход к каждому - залог нашего успеха. Наивысшее удовольствие для нас - довольный Турист, с которым Мы поделились частичкой Культуры и Вдохновения этой многогранной страны-сказки. Наши гиды - Русскоговорящие Профессионалы пропитанные местной культурой. Они сумеют не только показать и рассказать Вам самое интересное про места входящие в выбранный Вами тур, но и поделиться с Вами самыми сокровенными мыслями о стране, которые Вы не найдёте в интернете.</text>
      ...
      <div v-else>
        ...
        <div class="q-ma-md q-mt-xl col-12" >
          ...
          <div class="text-center col-12 q-ma-md">
            <text class="row justify-center text-subtitle1">Мы современная туристическая компания которую ведёт Малайзийский Дух. Индивидуальный подход к каждому - залог нашего успеха. Наивысшее удовольствие для нас - довольный Турист, с которым Мы поделились частичкой Культуры и Вдохновения этой многогранной страны-сказки. Наши гиды - Русскоговорящие Профессионалы пропитанные местной культурой. Они сумеют не только показать и рассказать Вам самое интересное про места входящие в выбранный Вами тур, но и поделиться с Вами самыми сокровенными мыслями о стране, которые Вы не найдёте в интернете.</text>
    ...
    return{
      ...
      ratings: [
        ...
        },
        {
          ...
          score: "4.5",
          comment: "Взяли туры в гентинг и пещеры бату, очень понравилось. Мне очень понравился сам гид!"
        }
      ]
    }
