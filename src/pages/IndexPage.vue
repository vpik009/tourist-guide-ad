    ...
    return{
      ...
      excursions: [
        { title: "Обзорный Тур по Куала-Лумпуру",
          ...
          price: "$55/персона при наличии двух или более персон. 120$ VIP тур для одного человека. Ваши дети проходят бесплатно. Максимальное количество участников 2 человека.",
